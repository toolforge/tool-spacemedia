package org.wikimedia.commons.donvip.spacemedia.harvester.usaf.flickr;
...
public class UsafFlickrApplication extends AbstractHarvestingApplication {

    public static void main(String[] args) {
        SpringApplication.run(UsafFlickrApplication.class, args);
    }
}
