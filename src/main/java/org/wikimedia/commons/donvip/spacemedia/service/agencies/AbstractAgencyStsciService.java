 ...
 */
public abstract class AbstractAgencyStsciService extends AbstractAgencyService<StsciMedia, String, ZonedDateTime> {

    private static final Logger LOGGER = LoggerFactory.getLogger(AbstractAgencyStsciService.class);
    ...
    protected AbstractAgencyStsciService(StsciMediaRepository repository, String mission, String searchEndpoint,
