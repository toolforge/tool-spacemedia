...
public class NasaChandraService extends AbstractOrgHtmlGalleryService<NasaChandraMedia> {
    ...
    protected List<NasaChandraMedia> fillMediaWithHtml(String url, Document html, NasaChandraMedia media)
        ...
        try {
            ...
            if (content != null) {
                addMetadataFromLinks(url, content.getElementsByTag("a"), media);
            }
    ...
    private void addMetadataFromLinks(String url, Elements links, NasaChandraMedia media) {
        for (Element a : links) {
            ...
            if (!href.isEmpty() && !href.startsWith("mailto:") && !href.contains(".htm") && !href.contains(".xml")
                    ...
                    && !href.contains(".obj") && !href.contains("/xml/") && !href.contains("/openFITS/")
                    && !href.contains("/blog/") && !href.contains("/podcasts/") && !href.endsWith("_low.pdf")
                    && !href.endsWith("_lores.pdf")) {
