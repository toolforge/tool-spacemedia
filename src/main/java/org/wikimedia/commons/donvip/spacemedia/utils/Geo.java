...
public final class Geo {
    ...
    public static final List<String> CONTINENTS = Arrays.asList("Africa", "Antarctica", "Asia", "Australia", "Eurasia",
            "Europe", "Oceania", "America", "Central America", "North America", "South America");
