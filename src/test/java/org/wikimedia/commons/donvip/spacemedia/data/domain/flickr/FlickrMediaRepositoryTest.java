...
@EntityScan(basePackageClasses = { Media.class, FlickrMedia.class })
@EnableJpaRepositories(basePackageClasses = { MediaRepository.class, FlickrMediaRepository.class })
@ContextConfiguration(classes = TestDataJpa.Config.class)
class FlickrMediaRepositoryTest extends TestDataJpa {

    @Autowired
    private FlickrMediaRepository mediaRepository;
