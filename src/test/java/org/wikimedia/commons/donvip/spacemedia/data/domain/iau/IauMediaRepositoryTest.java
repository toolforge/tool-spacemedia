...
@EntityScan(basePackageClasses = { Media.class, DjangoplicityMedia.class, IauMedia.class })
@EnableJpaRepositories(basePackageClasses = { MediaRepository.class, DjangoplicityMediaRepository.class,
        IauMediaRepository.class })
@ContextConfiguration(classes = TestDataJpa.Config.class)
class IauMediaRepositoryTest extends TestDataJpa {

    @Autowired
    private IauMediaRepository mediaRepository;
