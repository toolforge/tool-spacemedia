...
class HubbleEsaServiceTest extends AbstractAgencyServiceTest {

    @MockBean
    private HubbleEsaMediaRepository repository;
    ...
    void testReadHtml() throws Exception {
        ...
        assertNotNull(media);
        assertEquals("potw2319a", media.getId());
    ...
    static class TestConfig {
        ...
        @Bean
        @Autowired
        public HubbleEsaService service(HubbleEsaMediaRepository repository,
