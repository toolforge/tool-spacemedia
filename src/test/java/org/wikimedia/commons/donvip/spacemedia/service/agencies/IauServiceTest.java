...
class IauServiceTest extends AbstractAgencyServiceTest {
    ...
    void testReadHtml() throws Exception {
        assertEquals(
                "IauMedia [id=ann22001b, imageType=Artwork, date=2022-01-04T11:30, dimensions=[width=2605, height=3689], types=[Unspecified], categories=[Illustrations], credit=IAU/GA2022, fullResMetadata=Metadata [assetUrl=https://www.iau.org/static/archives/images/original/ann22001b.tif, ], metadata=Metadata [assetUrl=https://www.iau.org/static/archives/images/large/ann22001b.jpg, ], title=Season’s Greetings from the IAUGA2022 team, description=Season’s Greetings from the IAUGA2022 team., ]",
                service
