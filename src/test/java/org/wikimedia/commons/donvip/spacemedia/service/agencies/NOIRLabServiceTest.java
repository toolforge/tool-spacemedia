...
class NOIRLabServiceTest extends AbstractAgencyServiceTest {
    ...
    void testReadHtmlTime4() throws Exception {
        // Feb. 9, 2021, noon
        assertEquals(
                "NOIRLabMedia [id=ann20019a, imageType=Artwork, date=2021-02-09T12:00, dimensions=[width=801, height=801], objectType=[], objectCategories=[Illustrations], credit=Rubin Observatory/NSF/AURA, fullResMetadata=Metadata [assetUrl=https://noirlab.edu/public/media/archives/images/original/ann20019a.tif, ], sha1=Metadata [assetUrl=https://noirlab.edu/public/media/archives/images/large/ann20019a.jpg, ], title=Rubin Observatory Logo, description=Rubin Observatory Logo, ]",
